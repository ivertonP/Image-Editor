 ...
 * @author ivert
 */
public class LoadYIQFrame extends javax.swing.JFrame {

    /**
     * Creates new form LoadYIQFrame
     */
    public LoadYIQFrame() {
        initComponents();
        setLocationRelativeTo(null);
        setIconeLoadYIQFrame();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Carregando configs. YIQ");
        setAlwaysOnTop(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoadYIQFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LoadYIQFrame().setVisible(true);
            }
        });
    }
    
    public void setIconeLoadYIQFrame(){
        try{
