 ...
 * @author Iverton
 */
public class ControlFrameFilter extends javax.swing.JFrame {

    /**
     * Creates new form ControlFilter
     */
    public ControlFrameFilter() {
        initComponents();
        setLocationRelativeTo(null);
        setIconeControlFilterFrame();
    }
    ...
    private void Reverter(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Reverter
        ...
        jTextField2.setText("0");
        jTextField1.setText("0");
        Filter.reverterFilter();
    }//GEN-LAST:event_Reverter

    private void formWindowClosed(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosed
        if(Filter.applied == true){
            Filter.applied = false;
            meuJFrame.controlFrameFilter.setEnabled(false);
    ...
    private void Halftone(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Halftone
        Filter.Dithering();
    }//GEN-LAST:event_Halftone

    public void setIconeControlFilterFrame(){
        try{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ControlFrameFilter.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new ControlFrameFilter().setVisible(true);
        });
    }
