 ...
 */
public class ControlFrameHist extends javax.swing.JFrame {

    /**
     * Creates new form HistFrame
     */
    public ControlFrameHist() {
        initComponents();
        setLocationRelativeTo(null);
        setIconeControlFrameHist();
    }
    
    public void setIconeControlFrameHist(){
        try{
    ...
    private void initComponents() {
        ...
        HistPanel = meuJFrame.getPanelOriginal();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ControlFrameHist.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new ControlFrameHist().setVisible(true);
        });
    }
