 ...
 * @author Iverton
 */
public class ControlFrameMorph extends javax.swing.JFrame {

    /**
     * Creates new form ControlMorphFrame
     */
    public ControlFrameMorph() {
        initComponents();
        setLocationRelativeTo(null);
        setIconeControlFrameMorph();
    }
    ...
    private void initComponents() {
        ...
        jButton6.setText("Invert Vert");
        jButton6.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                EspelharVertical(evt);
            }
        });
        ...
        jButton7.setText("Invert Horiz");
        jButton7.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                EspelharHorizontal(evt);
            }
        });
    ...
    private void Reverter(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Reverter
        jSpinner1.setValue(0);
        MorphTransform.reverterMorph();
    }//GEN-LAST:event_Reverter

    private void formWindowClosed(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosed
        if(MorphTransform.applied == true){
            MorphTransform.applied = false;
            meuJFrame.controlFrameMorph.setEnabled(false);
    ...
    private void Rotacao90(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Rotacao90
        MorphTransform.Rotacao90();
    }//GEN-LAST:event_Rotacao90

    private void EspelharVertical(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EspelharVertical
        MorphTransform.EspelharVertical();
    }//GEN-LAST:event_EspelharVertical

    private void EspelharHorizontal(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EspelharHorizontal
        MorphTransform.EspelharHorizontal();
    }//GEN-LAST:event_EspelharHorizontal

    public void setIconeControlFrameMorph(){
        try{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ControlFrameMorph.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ControlFrameMorph().setVisible(true);
            }
        });
    }
