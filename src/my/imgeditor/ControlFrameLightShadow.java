 ...
 * @author Iverton
 */
public class ControlFrameLightShadow extends javax.swing.JFrame {

    /**
     * Creates new form ControlFrameLuminance
     */
    public ControlFrameLightShadow() {
        initComponents();
        setLocationRelativeTo(null);
        setIconeControlFrameLightShadow();
    }
    ...
    private void formWindowClosed(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosed
        if(LightShadow.applied == true){
            LightShadow.applied = false;
            meuJFrame.controlFrameLightShadow.setEnabled(false);
    ...
    private void Brilho(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_Brilho
        ...
        LightShadow.Brilho(x);
    }//GEN-LAST:event_Brilho

    private void Luminance(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_Luminance
        int x = (int)jSpinner2.getValue();
        LightShadow.Luminosidade(x);
    }//GEN-LAST:event_Luminance

    private void Gamma(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_Gamma
        int x = (int)jSpinner3.getValue();
        LightShadow.Gamma(x);
    }//GEN-LAST:event_Gamma
    ...
    private void GAMMA(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GAMMA
        int x = (int)jSpinner3.getValue();
        LightShadow.Gamma(x);
    }//GEN-LAST:event_GAMMA

    public void setIconeControlFrameLightShadow(){
        try{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ControlFrameLightShadow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new ControlFrameLightShadow().setVisible(true);
        });
    }
