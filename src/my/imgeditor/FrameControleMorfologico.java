 ...
 * @author Iverton
 */
public class FrameControleMorfologico extends javax.swing.JFrame {

    /**
     * Creates new form ControlMorphFrame
     */
    public FrameControleMorfologico() {
        initComponents();
        setLocationRelativeTo(null);
        setIconeFrameControleMorfologico();
    }
    ...
    private void initComponents() {
        ...
        jButton6.setText("Inverter Vert");
        ...
        jButton7.setText("Inverter Horiz");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameControleMorfologico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrameControleMorfologico().setVisible(true);
            }
        });
    }
