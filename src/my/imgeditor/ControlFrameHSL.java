 ...
 * @author Iverton
 */
public class ControlFrameHSL extends javax.swing.JFrame {

    /**
     * Creates new form ControlFrameHSL
     */
    public ControlFrameHSL() {
        initComponents();
        setLocationRelativeTo(null);
        setIconeControlFrameHSL();
    }
    ...
    private void initComponents() {
        ...
        getAccessibleContext().setAccessibleName("HSL");
    ...
    private void formWindowClosed(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosed
        if(HSL.applied == true){
            HSL.applied = false;
            meuJFrame.controlFrameHsl.setEnabled(false);
            Check.cod = HSL.HSLid;
    ...
    public void setIconeControlFrameHSL(){
        try{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ControlFrameHSL.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new ControlFrameHSL().setVisible(true);
        });
    }
